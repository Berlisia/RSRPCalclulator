...
const std::vector<ModulationSchemeAndSnrMapping> modulationAndSnrMappingTable =
{
    ...
    {Modulation::QAM64,   0.4551,   4.9185,  6.7005},
    {Modulation::QAM64,   0.5537,   6.7005,  8.7198},
    {Modulation::QAM64,   0.6504,   8.7198,  10.515},
    {Modulation::QAM64,   0.7539,   10.515,  12.450},
    {Modulation::QAM64,   0.8525,   12.450,  14.348},
    {Modulation::QAM256,  0.6943,   14.348,  16.074},
    {Modulation::QAM256,  0.7783,   16.074,  17.877},
    {Modulation::QAM256,  0.8634,   17.877,  19.968},
    {Modulation::QAM256,  0.9258,   19.968,  40},
};
